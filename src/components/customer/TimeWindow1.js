...
class TimeWindow1 extends Component<{}> {
  constructor(props) {
    super(props);
    this.state = {
      ProgressWidth: 5,
  ...
  render() {
    ...
    return (
      <ImageBackground style={[styles.completePercent]} source={require('../../assets/images/customer/blue1.png')}>
...
export default connect(state => ({ state: state.CustomerReducer }))(TimeWindow1);
