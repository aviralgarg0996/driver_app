        ...
        .then(() => {
          ...
          fetch(Connection.getResturl() + url, {
            ...
            .catch(error => {
              fulfill({
                message:
                  'Please check your internet connectivity or our server is not responding.url-' +
                  url,
              });
    ...
    return new Promise(function(fulfill) {
      context
        ...
        .then(() => {
          ...
          axios
            .post(Connection.getResturl() + url, params, headerObj)
            .then(response => {
        ...
        .then(() => {
          fetch(
            'https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=' +
              ...
              '&destinations=' +
              destiantion +
              '&key=AIzaSyAQFeoAvJ9Dgz2O-E9E1hx9Tuf6ofPy9Lg',
            {
              method: 'GET',
              timeout: 1000 * 1 * 60,
              headers: {
