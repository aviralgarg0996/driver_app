  ...
  shareItem = async () => {
    try {
      const result = await Share.share({
        title: "Its Here",
        message: "Refer your friend and get 10$ on adding money by your friend, Link: https://play.google.com/store/apps/details?id=com.itshere",
      ...
      >
        ...
        >
          <View style={[styles.flexRow]}>
            <TouchableOpacity onPress={() => this.onPressInfo(1)}
              style={[styles.colIndex, this.setViewColorOnClick(this.props.state.DeliveryFlag)]}>
              <Text style={this.setTextColorOnClick(this.props.state.DeliveryFlag)}>{'Delivery Service'}</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => this.onPressInfo(2)}
              style={[styles.colIndex, this.setViewColorOnClick(this.props.state.HourlyFlag)]}>
              <Text style={this.setTextColorOnClick(this.props.state.HourlyFlag)}>{'Hourly Service'}</Text>
            </TouchableOpacity>
          </View>
        </View>

        <ScrollView style={{ flex: 1, bottom: Constants.BaseStyle.DEVICE_HEIGHT / 100 * 1, backgroundColor: Constants.Colors.BackgroundBlue }}>
          ...
          <TouchableOpacity style={[styles.cardView]} onPress={() => { this.shareItem() }}>
            <View style={styles.flexRow}>
              <View style={{ flex: 0.4 }}>
