...
class Orders_Pending extends Component<{}> {
  ...
  setControlTextColor(value) {
    if (value == 1)
      return [
        styles.textStyle,
        {color: Constants.Colors.White, marginBottom: scaleHeight(20)},
      ];
    else {
  ...
  async onClickProducts() {
    ...
    console.log(
      'pickup details++++++',
      JSON.stringify(detailsInfo.orders[0].furniture[0]),
    );
  ...
  getDerivedStateFromProps(nextProps) {
    ...
    let new_date = moment
      .utc(detailsInfo.updatedAt, 'YYYY-MM-DDTHH:mm:ss Z')
      .format('DD/MM/YYYY');
    this.setState({
  ...
  render() {
    ...
    return (
      <View
        style={[styles.container, {backgroundColor: Constants.Colors.White}]}>
        <HeaderBackgroundWithBackButton
          navigation={navigate}
          goBack={goBack}
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => this.onClickGeneral()}
            style={[
              styles.colorChange,
              this.setViewColorOnClick(this.state.generalFlag),
            ]}>
            <Text style={this.setControlTextColor(this.state.generalFlag)}>
              {'General'}
            </Text>
          </TouchableOpacity>
          <View
          ...
          <TouchableOpacity
            ...
            style={[
              ...
              this.setViewColorOnClick(this.state.locationFlag),
            ]}>
            <Text style={this.setControlTextColor(this.state.locationFlag)}>
              {'Locations'}
            </Text>
          </TouchableOpacity>
          <View
          ...
          <TouchableOpacity
            ...
            style={[
              ...
              this.setViewColorOnClick(this.state.servicesFlag),
            ]}>
            <Text style={this.setControlTextColor(this.state.servicesFlag)}>
              {'Services'}
            </Text>
          </TouchableOpacity>
          <View
          ...
          <TouchableOpacity
            ...
            style={[
              ...
              this.setViewColorOnClick(this.state.productFlag),
            ]}>
            <Text style={this.setControlTextColor(this.state.productFlag)}>
              {'Products'}
            </Text>
          </TouchableOpacity>
        </View>
        ...
        {this.state.generalFlag == 1 ? (
          ...
          <ScrollView
            ...
            <ImageBackground
              ...
              <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                {this.props.orderDetails.deliveryName == 'Food' ? (
                  <Image
                    resizeMode="center"
                    source={Constants.Images.customer.newFood}
                    style={[styles.picSize]}
                  />
                ) : null}
                {this.props.orderDetails.deliveryName == 'Documents' ? (
                  <Image
                    resizeMode="center"
                    source={Constants.Images.customer.newDocument}
                    style={[styles.picSize]}
                  />
                ) : null}
                {this.props.orderDetails.deliveryName == 'Courier & Frieght' ? (
                  <Image
                    resizeMode="center"
                    source={Constants.Images.customer.newCourier}
                    style={[styles.picSize]}
                  />
                ) : null}
                {this.props.orderDetails.deliveryName ==
                'Furniture & Appliances' ? (
                  <Image
                    resizeMode="center"
                    source={Constants.Images.customer.newFurniture}
                    style={[styles.picSize]}
                  />
                ) : null}
                {this.props.orderDetails.deliveryName == 'Hourly Services' ? (
                  <Image
                    resizeMode="center"
                    source={Constants.Images.customer.newHourly}
                    style={[styles.picSize]}
                  />
                ) : null}
              </View>
              <View>
                <Text style={[styles.orderTextStyle, {textAlign: 'center'}]}>
                  {'Order Id : '}
                  {this.state.orderId}
                </Text>
              </View>
              <Text
                ...
                <Text style={{color: Constants.Colors.LightGray}}>
                  {'Delivery Date: '}
                </Text>
                {this.state.date}
              </Text>
              ...
              <View
                ...
                <TouchableOpacity>
                  <Image
                    source={Constants.Images.customer.info}
                    style={[styles.infoimgSize]}
                    resizeMode={'center'}
                  />
                </TouchableOpacity>
                <Text
                  style={[
                    styles.orderTextStyle,
                    {textAlign: 'center', color: Constants.Colors.White},
                  ]}>
                  {' '}
              ...
              <SubmitButton
                onPress={() => {
                  ...
                  this.props.navigation.dispatch({
                    type: 'SET_INVOICE',
                    _data: this.props.orderDetails,
                    _orders: this.props.orderDetails,
                  });
          ...
          <ScrollView
            style={[
              styles.container,
              {
                backgroundColor:
                  Constants.Colors
                    .LightBlue /*,height:Constants.BaseStyle.DEVICE_HEIGHT/100 * 18*/,
              },
            ]}>
            <FlatList
                  ...
                  <View style={{padding: scaleHeight(20)}}>
                    <View style={{flexDirection: 'row'}}>
                      <Image
                        resizeMode="center"
                        style={styles.locImg}
                        source={Constants.Images.customer.pickup}
                      />
                      {this.props.orderDetails.deliveryName ==
                      'Hourly Services' ? (
                        <Text style={styles.pickTitle}>Start Location</Text>
                      ) : (
                        <Text style={styles.pickTitle}>Pickup {index + 1}</Text>
                      )}
                    </View>
                  ...
                  <View style={{padding: scaleHeight(20)}}>
                    <View style={{flexDirection: 'row'}}>
                      <Image
                        resizeMode="center"
                        style={styles.locImg}
                        source={Constants.Images.customer.drop}
                      />
                      {this.props.orderDetails.deliveryName ==
                      'Hourly Services' ? (
                        <Text
          ...
          <ScrollView
              ...
              renderItem={({item, index}) => (
                <ImageBackground
                  ...
                  <View style={{padding: scaleHeight(20)}}>
                    ...
                    <View style={styles.serveView}>
                      {this.state.WhiteGlove ? (
                        <View style={styles.joinText}>
                          <Image
                            ...
                            source={Constants.Images.customer.white_glove}
                          />
                      ...
                      {this.state.ExtraHelper ? (
                        <View style={styles.joinText}>
                          <Image
                            style={styles.imgSize}
                            source={Constants.Images.customer.extra_helper}
                          />
                    ...
                    <View
                      style={[styles.serveView, {marginTop: scaleWidth(12)}]}>
                      {this.state.Residence ? (
                        <View style={styles.joinText}>
                          <Image
                            style={styles.imgSize}
                            source={Constants.Images.customer.residential}
                          />
                      ...
                      {this.state.TailGate ? (
                        <View style={styles.joinText}>
                          <Image
                            style={styles.imgSize}
                            source={Constants.Images.customer.tailgate}
                          />
            ...
            />
            <View
              style={{marginBottom: scaleHeight(30), color: 'transparent'}}
            />
          </ScrollView>
