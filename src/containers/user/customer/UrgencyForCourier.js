...
class UrgencyForCourier extends Component<{}> {
 ...
 async onClickRegular() {
  ...
  vehicalList(item) {
    ...
    return (
      <View style={[{ backgroundColor: Constants.Colors.LightGray, height: scaleHeight(75), width: Constants.BaseStyle.DEVICE_WIDTH / 100 * width }]}>
        ...
        <View style={{ flex: 1 }}>
          <ScrollView style={{ flex: 1 }}>
                ...
                <View style={{ alignItems: "center", justifyContent: "center" }}>
                  <TouchableOpacity onPress={() => this._showTimePicker()}
                    style={{
                      ...
                      backgroundColor: Constants.Colors.WhiteUpd, width: (Constants.BaseStyle.DEVICE_WIDTH / 100) * 20,
                      marginTop: scaleHeight(10)
                    }}>
                    <Text style={[styles.TimeText, { textAlign: 'center', fontFamily: Constants.CustomerFonts.semibold.fontFamily }]}>
            ...
            <View style={{ marginTop: scaleHeight(0), marginBottom: scaleHeight(25) }}>
              <ShadowButton
                onPress={() => this.props.navigation.navigate("UrgencyForCourier1")}
                text={'Next'}
