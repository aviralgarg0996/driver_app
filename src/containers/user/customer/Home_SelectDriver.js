...
class Home_SelectDriver extends Component<{}> {
    ...
    fetch(CustomerConnection.getTempUrl() + 'place-order/placeinpool', {
      ...
      .then(arr => {
        ...
        this.refs.toast.show(
          'Your order is successfully placed in pool.',
  ...
  checkPlaceInPool = () => {
    ...
    RestClient.get_New_Patch('place-order/orderDetails/' + this.orderID)
      .then(result => {
        console.log('order_details++', result);
        if (result.status == true) {
          if (this.props.state.Orders.orderId) {
            if (
              this.props.state.draft1 ||
              this.props.state.draft2 ||
              this.props.state.draft3
            ) {
            ...
            if (
              ...
              if (
                this.props.state.pick1 ||
                this.props.state.pick2 ||
                this.props.state.pick3
              ) {
                let routeName = 'CustomerOrders';
                this.setState({modalVisible: false}, () =>
                  this.props.navigation.navigate(routeName),
  ...
  render() {
    ...
    return (
      <View style={[styles.container]}>
        <StatusBar backgroundColor="#396CB3" barStyle="light-content" />
        ...
        <View style={styles.searchContainer}>
          <View
            ...
            {this.state.switchValue && (
              <TextInput
                autoFocus={false}
                onChangeText={text => this.filterDriverList(text)}
        ...
        <ScrollView>
          <View ref={component => (this.mapContainer = component)}>
            ...
            {this.state.markerData && (
              <Home_SelectDriverList data={this.state.markerData} />
            )}
          </View>

          <View
            ref={component => {
              this.listContainer = component;
            }}
            style={{height: 0}}>
            {this.state.driverdata && this.state.switchValue && (
              <Driver_ListView
                data={this.state.driverdata ? this.state.driverdata : []}
          ...
          <TouchableOpacity
            ...
            disabled={true ? this.state.buttonFlag : false}
            onPress={() => this.selectDriver()}>
            <Text style={[styles.SelectTextStyle]}>{'Place in the pool'}</Text>
          </TouchableOpacity>
          {/*
            <View style={[styles.container]}>
              {
            ...
            <KeyboardAvoidingView
              ...
              <ScrollView style={{flex: 1}}>
                <View style={styles.centerView}>
                  ...
                  <ImageBackground
                    resizeMode="cover"
                    style={{height: scaleHeight(310), width: '100%'}}
                    ...
                    <Text
                      style={[
                        ...
                        {
                          fontFamily:
                            Constants.CustomerFonts.semibold.fontFamily,
                        },
                      ]}>
                      {'No one accepted your order.'}
                    </Text>
                    <ShadowButton
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      this.setState({
                        showList: true,
                        flagCheck: !this.state.flagCheck,
                      })
                    }>
                    ...
                    <ImageBackground
                      ...
                      <View
                        ...
                        <View
                          ...
                          {this.state.check1 ? (
                            <TouchableOpacity
                              onPress={() => this.setState({check1: false})}>
                          ...
                          {this.state.check3 ? (
                            <TouchableOpacity
                              onPress={() => this.setState({check3: false})}>
                              <View style={styles.circleLogo1}>
                          ...
                          {this.state.check4 ? (
                            <TouchableOpacity
                              onPress={() => this.setState({check4: false})}>
                              <View style={styles.circleLogo1}>
