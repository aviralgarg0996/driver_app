...
class Home_Invoice extends Component<{}> {
    constructor(props) {
        ...
        //console.log('picked is===========', this.props.state.pickupArr)
...
console.log(this.props.state.DisplayLocationAddress);


        if(!this.props.state.pickupArr )
        return false;

else if(!this.props.state.DisplayLocationAddress)
return;
    ...
    render() {
        ...
        console.log("invoiceData",this.props.state)
        return (
            <View style={{ flex: 1, backgroundColor: Constants.Colors.LightBlue }}>
                ...
                <ScrollView>
                    {/* Pickup 1 */}
                    {   this.props.state.pickupArr[0] &&
                        this.props.state.pickupArr[0].address ? <ImageBackground style={{ marginBottom: scaleHeight(20) }} source={require('../../../assets/images/customer/blue.png')}>
                    ...
                    {/* Pickup 2 */}
                    {this.props.state.pickupArr[1] && this.props.state.pickupArr[1].address && this.props.state.pickupArr[1].address !== 'Choose Another Pickup Location' ? <ImageBackground style={{ marginBottom: scaleHeight(20) }} source={require('../../../assets/images/customer/blue.png')}>
                        <View style={[styles.flexRow, { marginLeft: scaleWidth(5), marginTop: scaleHeight(20) }]}>
                            <Image source={Constants.Images.customer.markerBlue} style={[styles.pickupIconStyle]} resizeMode={'contain'} />
                            <Text style={[styles.textStyle, { color: Constants.Colors.White, flex: 0.3, justifyContent: 'flex-start', textAlign: 'left', marginLeft: (Constants.BaseStyle.DEVICE_WIDTH / 100) * 2 }]}>
                                {'Pickup 2'}
                    ...
                    <ImageBackground resizeMode='cover' source={require("../../../assets/images/customer/blue.png")} style={{ marginBottom: scaleHeight(20) }}>
                        <View style={{ marginTop: scaleHeight(20) }}>
                            ...
                            {
                               this.state.serviceType == 'Courier & Frieght' || this.state.serviceType == 'Furniture & Appliances' || this.state.serviceType == 'Hourly Services' ? <View style={[styles.flexRow, { marginVertical: Constants.BaseStyle.DEVICE_WIDTH * 1 / 100 }]}>
                            ...
                            <View style={[styles.flexRow, { marginVertical: Constants.BaseStyle.DEVICE_WIDTH * 1 / 100 }]}>
                                ...
                                <View style={{ flex: 0.5, justifyContent: 'flex-end' }}>
                                    <Text style={[styles.textStyle, { color: Constants.Colors.White, textAlign: 'right', marginHorizontal: (Constants.BaseStyle.DEVICE_WIDTH / 100) * 5 }]}>
                                        {'$'}{this.props.state.InvoiceData.subTotal.toFixed(2)}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={[styles.flexRow, { marginBottom: Constants.BaseStyle.DEVICE_HEIGHT / 100 * 2, marginVertical: Constants.BaseStyle.DEVICE_WIDTH * 1 / 100 }]}>
                                ...
                                <View style={{ flex: 0.5, justifyContent: 'flex-end' }}>
                                    <Text style={[styles.textStyle, { color: Constants.Colors.White, textAlign: 'right', marginHorizontal: (Constants.BaseStyle.DEVICE_WIDTH / 100) * 5 }]}>
                                        {'$'}{this.props.state.InvoiceData.gstAmt.toFixed(2)}
                                    </Text>
                                </View>
                            </View>
